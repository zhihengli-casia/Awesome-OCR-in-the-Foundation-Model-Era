...
Badges indicate venue/source and year when available; GitHub badges report live star counts. The Date column records the paper or public source date; repository-only entries use the public GitHub repository creation date. Entries are ordered newest first within each subsection.
