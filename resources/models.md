...
| **EffOCR / EfficientOCR** | 2023.10 | sample-efficient OCR package based on character / word image retrieval | [arXiv](https://arxiv.org/abs/2310.10050), [EMNLP](https://aclanthology.org/2023.emnlp-demo.52/) | [GitHub](https://github.com/dell-research-harvard/efficient_ocr) | [Project](https://effocr.github.io/) |
...
| **SGRL** | 2023.08 | semantic graph representation learning for HMER | [arXiv](https://arxiv.org/abs/2308.10493), [ICDAR](https://doi.org/10.1007/978-3-031-41676-7_9) | - | - |
...
| **GriTS** | 2022.03 | grid table similarity metric for table structure recognition | [arXiv](https://arxiv.org/abs/2203.12555), [ICDAR](https://doi.org/10.1007/978-3-031-41734-4_33) | [GitHub](https://github.com/microsoft/table-transformer) | - |
...
|---|:---:|---|---|---|---|
| **PILOT / VISTA-OCR** | 2025.04 | promptable layout-aware encoder-decoder for full-page OCR, region reading, and text spotting | [arXiv](https://arxiv.org/abs/2504.03621), [IJDAR](https://doi.org/10.1007/s10032-026-00590-w) | - | - |
...
| **DocVLM** | 2024.12 | OCR-modality adapter for making frozen VLMs efficient document readers | [arXiv](https://arxiv.org/abs/2412.08746), [CVPR](https://openaccess.thecvf.com/content/CVPR2025/html/Nacson_DocVLM_Make_Your_VLM_an_Efficient_Reader_CVPR_2025_paper.html) | - | - |
...
| **SmolDocling** | 2025.03 | ultra-compact document conversion VLM | [arXiv](https://arxiv.org/abs/2503.11576), [ICCV](https://openaccess.thecvf.com/content/ICCV2025/html/Nassar_SmolDocling_An_ultra-compact_vision-language_model_for_end-to-end_multi-modal_document_conversion_ICCV_2025_paper.html) | [Docling](https://github.com/docling-project/docling) | [Hugging Face](https://huggingface.co/docling-project/SmolDocling-256M-preview) |
...
| **Molmo / NVLM** | 2024.09 / 2024.09 | open general VLM baselines for visual grounding, document, and OCR-rich perception | [Molmo](https://arxiv.org/abs/2409.17146), [Molmo CVPR](https://openaccess.thecvf.com/content/CVPR2025/html/Deitke_Molmo_and_PixMo_Open_Weights_and_Open_Data_for_State-of-the-Art_CVPR_2025_paper.html), [NVLM](https://arxiv.org/abs/2409.11402) | [Molmo](https://github.com/allenai/molmo) | [NVLM HF](https://huggingface.co/nvidia) |
...
| **mPLUG-Owl3** | 2024.08 | long image-sequence MLLM for multi-image and video visual-language tasks | [arXiv](https://arxiv.org/abs/2408.04840), [ICLR](https://openreview.net/forum?id=pr37sbuhVa) | [GitHub](https://github.com/X-PLUG/mPLUG-Owl) | [HF](https://huggingface.co/mPLUG/mPLUG-Owl3-7B-241101) |
| **Idefics2 / Idefics3** | 2024.05 / 2024.08 | open Hugging Face VLM line for OCR, document understanding, and visual reasoning | [Idefics2](https://arxiv.org/abs/2405.02246), [Idefics2 NeurIPS](https://proceedings.neurips.cc/paper_files/paper/2024/hash/a03037317560b8c5f2fb4b6466d4c439-Abstract-Conference.html), [Idefics3](https://arxiv.org/abs/2408.12637) | - | [Idefics2 HF](https://huggingface.co/HuggingFaceM4/idefics2-8b), [Idefics3 HF](https://huggingface.co/HuggingFaceM4/Idefics3-8B-Llama3) |
...
| Model / System | Date | OCR-Relevant Role | Paper | Code | Demo / Docs |
|---|:---:|---|---|---|---|
| **GPT-5 / GPT-5.5 family** | 2025-2026 | OpenAI closed multimodal API family for image/document prompting and OCR-rich reasoning | [GPT-5 model](https://developers.openai.com/api/docs/models/gpt-5), [System Card](https://cdn.openai.com/gpt-5-system-card.pdf) | - | [Latest model](https://developers.openai.com/api/docs/guides/latest-model), [Vision](https://developers.openai.com/api/docs/guides/images-vision) |
| **Claude 3 / 3.5 / 3.7 / 4 family** | 2024-2026 | Anthropic closed VLM family for image-input OCR, screenshots, charts, and document reasoning | [Claude 4](https://www.anthropic.com/news/claude-4), [Opus 4.7](https://www.anthropic.com/news/claude-opus-4-7) | - | [Models](https://platform.claude.com/docs/en/about-claude/models/overview) |
| **Grok 4.x / xAI API** | 2026 | API-first general VLM family with text-image chat prompts and image/PDF understanding | - | - | [Models](https://docs.x.ai/developers/models), [Image understanding](https://docs.x.ai/developers/model-capabilities/images/understanding) |
| **Amazon Nova family** | 2026 | Bedrock multimodal models for image, video, document, and code understanding | - | - | [What is Nova](https://docs.aws.amazon.com/nova/latest/userguide/what-is-nova.html), [Multimodal](https://docs.aws.amazon.com/nova/latest/userguide/modalities.html) |
| **Perplexity Sonar API** | 2026 | search-grounded API interface with image and file analysis for visual/document prompts | - | - | [Media](https://docs.perplexity.ai/docs/sonar/media), [Docs](https://docs.perplexity.ai/docs/getting-started/overview) |
| **Qwen API vision models** | 2026 | Alibaba Cloud / Qwen API visual understanding models for image and video prompts | - | - | [Model Studio](https://www.alibabacloud.com/help/en/model-studio/vision), [Qwen API](https://qwen.ai/apiplatform) |
| **GLM-4.6V / Z.ai API** | 2026 | Z.ai visual understanding model with long context, multimodal agents, and function calling | - | - | [Docs](https://docs.z.ai/guides/vlm/glm-4.6v) |
| **Tencent Hunyuan / HY API** | 2026 | Tencent general-purpose multimodal model family exposed through Tencent Cloud APIs | - | - | [Docs](https://www.tencentcloud.com/document/product/1284/75530) |
| **ERNIE 5.0 / ERNIE 4.5 VL** | 2025.11 | Baidu multimodal foundation-model family with Qianfan API access | [ERNIE 5.0](https://ernie.baidu.com/blog/posts/ernie5.0/), [ERNIE 4.5](https://ernie.baidu.com/blog/posts/ernie4.5/) | - | [Qianfan models](https://cloud.baidu.com/doc/qianfan-api/s/Dmba8k71y) |
| **Cohere Command A Vision** | 2025.07 | enterprise API VLM for charts, tables, document QA, multilingual OCR, and image analysis | [Blog](https://cohere.com/blog/command-a-vision) | - | [Docs](https://docs.cohere.com/docs/command-a-vision), [Image inputs](https://docs.cohere.com/docs/image-inputs) |
| **Doubao visual understanding / Volcengine Ark** | 2025 | ByteDance Doubao API models for image, video, document, and multimodal understanding | - | - | [Model list](https://www.volcengine.com/docs/82379/1330310), [Image understanding](https://www.volcengine.com/docs/82379/1362931) |
| **OpenAI o3 / o4-mini** | 2025.04 | closed reasoning VLMs for visual reasoning and OCR-rich problem solving | [System Card](https://cdn.openai.com/pdf/2221c875-02dc-4789-800b-e7758f3722c1/o3-and-o4-mini-system-card.pdf) | - | [o3](https://developers.openai.com/api/docs/models/o3), [o4-mini](https://developers.openai.com/api/docs/models/o4-mini), [Vision](https://developers.openai.com/api/docs/guides/images-vision) |
| **GPT-4.1 family** | 2025.04 | OpenAI API VLM family with long-context text-image prompting | [Model](https://developers.openai.com/api/docs/models/gpt-4.1) | - | [Vision](https://developers.openai.com/api/docs/guides/images-vision) |
| **Mistral multimodal API / Pixtral Large** | 2024.11 | Mistral API multimodal interface for documents, charts, and natural images | [Pixtral Large](https://docs.mistral.ai/models/model-cards/pixtral-large-24-11) | - | [Models](https://docs.mistral.ai/models/overview) |
| **GPT-4o family** | 2024.05 | closed general VLM OCR interface across text, image, audio, and real-time interaction | [Model](https://developers.openai.com/api/docs/models/gpt-4o), [System Card](https://cdn.openai.com/gpt-4o-system-card.pdf) | - | [Vision](https://developers.openai.com/api/docs/guides/images-vision) |
| **Reka Core / Flash / Edge** | 2024.04 | proprietary multimodal model family with API access for text, image, video, and audio inputs | [arXiv](https://arxiv.org/abs/2404.12387) | - | [Docs](https://docs.reka.ai/), [Flash updates](https://reka.ai/news/reka-flash-updates) |
| **Gemini 1.x / 2.x family** | 2023.12 | Google closed general multimodal family for image, video, and document prompting through Gemini API | [arXiv](https://arxiv.org/abs/2312.11805) | - | [Image docs](https://ai.google.dev/gemini-api/docs/image-understanding), [Models](https://ai.google.dev/gemini-api/docs/models) |
| **GPT-4V** | 2023 | early closed general VLM OCR interface | [GPT-4V system card](https://cdn.openai.com/papers/GPTV_System_Card.pdf) | - | [Vision](https://developers.openai.com/api/docs/guides/images-vision) |
